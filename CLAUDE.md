...
root (currently `EquaSolve_V1_3_102.html`) in a browser and it runs. Author: Dr. Omar Al-Abbasi, Mechanical Engineering, University of
...
repository is small (~1 MB for all 67 builds, thanks to delta compression), so sync
