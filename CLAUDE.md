...
root (currently `EquaSolve_V1_3_103.html`) in a browser and it runs. Author: Dr. Omar Al-Abbasi, Mechanical Engineering, University of
...
repository is small (~1 MB for all 68 builds, thanks to delta compression), so sync
